...
export interface BlogPostSection {
  ...
  export const articles: Article[] = [
    ...
    image: "/MagazinesWebsite/assets/FeaturedArticlesImages/Research.jpg",
    category: "Research",
    readTime: "8 min",
    featured: true,
    content: [
    ...
    image: "/MagazinesWebsite/assets/FeaturedArticlesImages/GreenCampus.jpg",
    category: "Campus Life",
    readTime: "5 min",
    content: [
    {
    ...
    image: "/MagazinesWebsite/assets/FeaturedArticlesImages/MentalHealth.jpg",
    ...
    image: "/MagazinesWebsite/assets/FeaturedArticlesImages/QuantumLab.jpg",
    category: "Innovation",
    readTime: "7 min",
    featured: true,
    content: [
