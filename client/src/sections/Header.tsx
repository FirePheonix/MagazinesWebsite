...
const Header: React.FC = () => {
  ...
  // Token
    // Update your hook declaration to include isSignedIn
    ...
    const fetchToken = async () => {
      if (isSignedIn) {
        try {
          ...
          if (!token) {
            console.log("Token is null despite user being signed in");
          }
        } catch (error) {
              ...
              {navigationData.links.map((link) => (
                <Link
                  ...
                  className="px-2 lg:px-3 py-2 text-gray-700 hover:text-blue-600 font-medium rounded-md 
                     transition-all duration-200 hover:bg-gray-50 text-xs lg:text-sm"
                  onClick={handleNavigation}
                >
                  {link.label}
                </Link>
      ...
      {isOpen && (
        ...
        >
          <div className="flex flex-col h-full">
            ...
            {/* CTA button footer with Clerk Authentication */}
            <div className="p-4 border-t border-gray-200 sticky bottom-0 bg-white">
              ...
              <SignedIn>
                <div className="flex items-center justify-center">
                  ...
                  />
                  <span className="ml-3 text-gray-700 font-medium">Your Account</span>
                </div>
              </SignedIn>
            </div>
          </div>
